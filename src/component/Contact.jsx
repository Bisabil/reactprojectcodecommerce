    ...
    <div id="contact" className=" max-w-[1140px] m-auto w-full p-4 py-16">
      ...
      <div className=" grid md:grid-cols-2  ">
        <img
          ...
          src="https://images.unsplash.com/photo-1668455199701-284281127a87?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1064&q=80"
          alt=""
        />
        <form>
